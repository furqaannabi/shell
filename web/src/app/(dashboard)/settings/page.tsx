export default function SettingsPage() {
  return (
    <div className="w-full h-full overflow-y-auto pb-8 pr-2">
        ...
        <div className="lg:col-span-7 flex flex-col gap-margin">
          ...
          <section className="glass-panel rounded-lg p-6 border border-outline-variant">
            ...
            <div className="space-y-6">
              {/* Connected Wallet */}
              <div className="flex items-center justify-between p-4 bg-surface rounded border border-outline-variant hover:bg-surface-container transition-colors">
                ...
                <button className="px-3 py-1 border border-outline-variant text-on-surface-variant font-mono-sm text-mono-sm rounded hover:text-error hover:border-error transition-colors">
                  Disconnect
                </button>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-surface rounded border border-outline-variant">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-surface-container-highest flex items-center justify-center border border-outline-variant shadow-[0_0_8px_rgba(45,212,191,0.3)]">
                ...
                <div className="font-mono-sm text-mono-sm text-primary">VERIFIED</div>
              </div>
            </div>
          </section>
      ...
      {/* Action Footer */}
      <div className="mt-8 pt-4 flex justify-end gap-4 border-t border-outline-variant pb-8">
        <button className="px-6 py-2 border border-outline-variant text-on-surface-variant font-mono-sm text-mono-sm font-semibold rounded hover:bg-surface-container transition-colors">
          Discard Changes
        </button>
        <button className="px-6 py-2 bg-primary text-[#0A0C10] font-mono-sm text-mono-sm font-semibold rounded hover:shadow-[0_0_8px_rgba(45,212,191,0.3)] transition-all">
          Save Configuration
        </button>
      </div>
    </div>
