...
| Atomic settlement (`settle_direct<TBase, TQuote>`)  | ✅ live on testnet                                      | `move/sources/settlement.move`                 |
...
**Testnet package**: `0x954e90623a2831fbe4bcee5db0418c82db92792425a560b9a06a17327063911d` (latest published-at)
**Enclave**: `0x68dc5a07cf93a6ba990f1866f988f24d366b314130500f045506b024dc134a5f` at `https://sui.furqaannabi.com`
...
Trader gives a parent intent ("sell 10M SUI over 4 hours, max 2 bps impact"). An LLM agent slices the order into child orders, times their submission against an external price reference (e.g. Pyth oracle), and submits each as a normal sealed Shell order. After completion, the LLM generates a TCA report from the journal: realised price vs benchmark, slippage per child, decision rationale per slice.
...
1. Read inputs:
     ...
     - market reference (Pyth oracle price)
