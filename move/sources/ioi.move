...
use shell::shell::{Self as shell_mod, SHELL};
use sui::event;
...
/// Emitted by the registered Shell enclave after pairing two IOIs and
...
public fun propose_match(
    ...
    assert!(ctx.sender() == shell_mod::enclave_address(enclave), ENotEnclave);
